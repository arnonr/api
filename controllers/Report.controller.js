...
const methods = {
    ...
    async onGetReport26(req, res) {
        try {
            let result = await Service.report26(req);
            res.success(result);
        } catch (error) {
            res.error(error);
        }
    ...
    async onGetReport27(req, res) {
        try {
            let result = await Service.report27(req);
            res.success(result);
        } catch (error) {
            res.error(error);
        }
    ...
    async onGetReport28(req, res) {
        try {
            let result = await Service.report28(req);
            res.success(result);
        } catch (error) {
            res.error(error);
        }
    ...
    async onGetReport29(req, res) {
        try {
            let result = await Service.report29(req);
            res.success(result);
        } catch (error) {
            res.error(error);
        }
    ...
    async onGetReport101(req, res) {
        try {
            let result = await Service.report101(req);
            res.success(result);
        } catch (error) {
            res.error(error);
        }
