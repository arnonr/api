            ...
            if (giveBirth) {
                ...
                if (!yearling) {
                    ...
                    if (this.AnimalStatusID == 3 || this.AnimalStatusID == 5) {
                        ...
                        this.AnimalStatusID == 8 ||
                        this.AnimalStatusID == 10
                    ) {
                        if (day >= 30) {
                            noti.push(`ครบกําหนดติดตามลูกเกิดหลังคลอด`);
                        }
                    } else if (
                        this.AnimalStatusID == 13 ||
                        this.AnimalStatusID == 15
                    ) {
                        if (day >= 30) {
                            noti.push(`ครบกําหนดติดตามลูกเกิดหลังคลอด`);
                        }
            ...
            if (embryo.TimeNo > ai.TimeNo) {
                ...
                var data = {
                    ...
                    ThaiAIDate: dayjs(ai.AIDate)
                        .locale("th")
                        .format("DD/MM/BBBB"),
                    ThaiEventLatest: dayjs(ai.AIDate)
                        .locale("th")
                        .format("DD/MM/BBBB"),
                    EmbryoDate: null,
                    PregnancyStatus: pregResult,
...
Animal.init(
    {
                    ...
                    Animal.findOne({
                        ...
                        .then(function (data) {
                            if (data && self.AnimalID !== data.AnimalID) {
                                throw new Error(
                                    "Animal Identification already in use!"
                                );
                            }
                            return next();
                        })
        ...
        AnimalNationalID: {
            ...
            validate: {
                isUnique: function (value, next) {
                    let self = this;
                    Animal.findOne({
                        where: { AnimalNationalID: value, isRemove: 0 },
                    })
                        .then(function (data) {
                            if (
                                data &&
                                ...
                                throw new Error(
                                    "Animal National ID already in use!"
                                );
                            }
                            return next();
                        })
        ...
        AnimalEarID: {
            ...
            validate: {
                isUnique: function (value, next) {
                    let self = this;
                    Animal.findOne({
                        where: { AnimalEarID: value, isRemove: 0 },
                    })
                        .then(function (data) {
                            if (
                                data &&
        ...
        AnimalMicrochip: {
            ...
            validate: {
                isUnique: function (value, next) {
                    let self = this;
                    Animal.findOne({
                        where: { AnimalMicrochip: value, isRemove: 0 },
                    })
                        .then(function (data) {
                            if (
                                data &&
                                ...
                                throw new Error(
                                    "Animal Microchip already in use!"
                                );
                            }
                            return next();
                        })
        ...
        AnimalAlive: {
            ...
            allowNull: false,
            comment:
                "สถานะการมีชีวิต  0=เสียชีวิต, 1=มีชีวิต, 2=ขาย, 3=คัดทิ้ง",
        },
        AnimalTypeID: {
            type: DataTypes.INTEGER(11),
            allowNull: false,
        ...
        AnimalBreedAll: {
            ...
            get() {
                ...
                if (
                    this.AnimalBreedID1 != null &&
                    this.AnimalBreed1 != undefined
                ) {
                    let breed = this.AnimalBreed1.toJSON();
                ...
                if (
                    this.AnimalBreedID2 != null &&
                    this.AnimalBreed2 != undefined
                ) {
                    let breed = this.AnimalBreed2.toJSON();
                    animalBreed =
                        animalBreed +
                ...
                if (
                    this.AnimalBreedID3 != null &&
                    this.AnimalBreed3 != undefined
                ) {
                    let breed = this.AnimalBreed3.toJSON();
                    animalBreed =
                        animalBreed +
                ...
                if (
                    this.AnimalBreedID4 != null &&
                    this.AnimalBreed4 != undefined
                ) {
                    let breed = this.AnimalBreed4.toJSON();
                    animalBreed =
                        animalBreed +
                ...
                if (
                    this.AnimalBreedID5 != null &&
                    this.AnimalBreed5 != undefined
                ) {
                    let breed = this.AnimalBreed5.toJSON();
                    animalBreed =
                        animalBreed +
