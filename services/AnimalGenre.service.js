  ...
  scopeSearch(req, limit, offset) {
    ...
    if (req.query.AnimalGenreName)
      $where["AnimalGenreName"] = {
        [Op.like]: "%" + req.query.AnimalGenreName + "%",
      };
  ...
  insert(data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const res = await db.findByPk(inserted.AnimalGenreID);
  ...
  update(id, data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        // Update
        data.AnimalGenreID = parseInt(id);
