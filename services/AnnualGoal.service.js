...
const methods = {
  scopeSearch(req, limit, offset) {
    ...
    if (req.query.AnnualGoalID) $where["AnnualGoalID"] = req.query.AnnualGoalID;

    if (req.query.OrganizationID)
      $where["OrganizationID"] = {
        [Op.like]: "%" + req.query.OrganizationID + "%",
      };
  ...
  insert(data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let res = methods.findById(inserted.AnnualGoalID);
