  ...
  scopeSearch(req, limit, offset) {
    ...
    if (req.query.SourceTypeCode)
      $where["SourceTypeCode"] = {
        [Op.like]: "%" + req.query.SourceTypeCode + "%",
      };

    if (req.query.SourceTypeName)
      $where["SourceTypeName"] = {
        [Op.like]: "%" + req.query.SourceTypeName + "%",
      };
  ...
  insert(data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const res = await db.findByPk(inserted.SourceTypeID);
