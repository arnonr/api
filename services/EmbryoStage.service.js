  ...
  scopeSearch(req, limit, offset) {
    ...
    if (req.query.EmbryoStageCode)
      $where["EmbryoStageCode"] = {
        [Op.like]: "%" + req.query.EmbryoStageCode + "%",
      };

    if (req.query.EmbryoStageGrade)
      $where["EmbryoStageGrade"] = {
  ...
  insert(data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const res = await db.findByPk(inserted.EmbryoStageID);
