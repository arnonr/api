const config = require("../configs/app"),
  ...
  db = require("../models/PositionType"),
...
data.createdAt = isoDateTime;
        ...
        const res = await db.findByPk(inserted.PositionTypeID);
  ...
  update(id, data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        // Update
        data.PositionTypeID = parseInt(id);
        ...
        await db.update(data, { where: { PositionTypeID: id } });
